...
< Append Name Here If You would like to use this license in same format. >
  
Last Updated: March 12, 2025

Code and assets are free to be distributed, remixed, adapted, and built upon provided the following conditions are met:

Applicable code and resources are within the following folders fall under this license:
./Animations
./Materials
./Mods/CoreAssets
./Scenes
...
./Shaders
./Textures
< Append Extra Paths here >

Mods added to the ./Mods folder may or may not be applicable depending on if the creators choose to append to the list above.
